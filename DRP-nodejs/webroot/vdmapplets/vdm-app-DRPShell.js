        ...
        async RunStartup() {
            ...
            */
            ...
            let watchWindowApplet = {
                ...
                appletClass: class TopicWatchApplet extends DRPApplet {
            ...
            class drpShell {
                constructor(vdmApp, term) {
                    ...
                    this.AddMethod(new drpMethod("ls",
                        ...
                        async function (switchesAndDataString, doPipeOut, pipeDataIn) {
                            ...
                            try {
                                ...
                                else term.write(`\x1B[91m${errMsg}\x1B[0m`);
                                return
                            }
                    ...
                    this.AddMethod(new drpMethod("exec",
                        "Execute RPC Method",
                    ...
                    this.AddMethod(new drpMethod("watch",
                        ...
                        async function (switchesAndDataString, doPipeOut, pipeDataIn) {
                            ...
                            if (switchesAndData.data) {
                                ...
                                await myApp.vdmDesktop.OpenApp(watchWindowApplet, {
                                    topicName: topicName,
                                    scope: scope,
            ...
            let insertString = (newText) => {
                if (lineCursorIndex < lineBuffer.length) {
                    if (insertMode) {
                        ...
                        lineBuffer = part1 + newText + part2;
                        term.write(newText);
                        term.write(part2 + " ");
                        let goBackString = "\b";
                        ...
                        lineBuffer = lineBuffer.substr(0, lineCursorIndex) + newText + lineBuffer.substr(lineCursorIndex + newText.length);
                        term.write(newText);
                    }
                } else {
                    lineBuffer += newText;
                ...
                lineCursorIndex += newText.length;
            }

            let processLineBuffer = async () => {
            ...
            let processPaste = async () => {
                ...
                for (let lineIdx = 0; lineIdx < lineArray.length; lineIdx++) {
                    insertString(lineArray[lineIdx]);
            ...
            */
            ...
            myApp.appVars.term.onData(async (e) => {
                ...
                switch (charCode) {
                    ...
                    //insertString(e);
                    //console.log(e.split('').map(function (c) { return c.charCodeAt(0); }));
                }
                //console.log(`${termBuffer.cursorX},${termBuffer.cursorY}`);
            });
